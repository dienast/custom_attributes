	...
	$('.field_type').change(function() {
		...
		switch($(this).val()) {
			case 'text':
				...
				$(this).parent().parent().next().find('.field_range').hide();	
				break;
			case 'select':	
				$(this).parent().parent().prev().show();
				$(this).parent().parent().next().next().find('.field_required').show();
				$(this).parent().parent().next().next().find('.field_range').show();	
				break;
			case 'radio':	
				$(this).parent().parent().prev().show();
				$(this).parent().parent().next().find('.field_required').show();
				$(this).parent().parent().next().find('.field_range').show();	
				break;					
			case 'checkbox': 
				$(this).parent().parent().prev().hide();
